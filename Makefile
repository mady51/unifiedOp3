...
AS		= $(CROSS_COMPILE)as
LD		= $(CROSS_COMPILE)ld.bfd --strip-debug
...
KBUILD_CFLAGS	+= -O3 -mllvm -polly -analyze -analyzer-purge -mllvm -polly-run-dce -mllvm -polly-vectorizer=stripmine -mllvm -polly-run-inliner -mllvm -polly-detect-keep-going
endif
